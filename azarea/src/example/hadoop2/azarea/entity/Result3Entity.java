...
public class Result3Entity extends DefaultEntity {
	...
	private static final EntitySchema schema = new GeneralEntitySchema("Result3Entity", ALL_COLUMNS, KEY_COLUMNS);
